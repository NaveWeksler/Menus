...
describe('Login tests', () => {
    beforeAll(async () => {
        ...
        await User.create({
            email: "logintestemail@gmail.com", password: await storePsw("password", salt), salt, firstName: "testF", lastName: "testL"
        });
    });
    ...
    it("valid user", async () => {
        await login(mockRequest("POST", { email: 'logintestemail@gmail.com', password: "password" }), res);
